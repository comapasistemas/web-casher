...
<form action="{{ route('registrar.store') }}" method="post" autocomplete="off">
    ...
    <div>
        ...
        <label for="checkboxAceptoTerminosCondiciones">He leído y acepto los <a href="{{ route('contrato.index') }}" target="_blank">términos y condiciones</a> del servicio de la aplicación de Comapa.</label>
    </div>
    <br>
